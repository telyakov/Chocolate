...
ChFilter.prototype.getChForm = function(){
    if(this.chForm === null){
       this.chForm = ChObjectStorage.create(this.$elem.closest('.section-filters').siblings('.section-grid').children('form'), 'ChGridForm')
    }
    return this.chForm;
};
...
ChFilter.prototype.getChFilterForm = function(){
    if(this.chFilterForm == null){
        this.chFilterForm = ChObjectStorage.create(this.$elem.closest('form'), 'ChFilterForm');
    }
