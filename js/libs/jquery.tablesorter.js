...
//                            console.log(cols)
            ...
            function buildHeaders(table) {
                ...
                c.$headers = $(table).find(c.selectorHeaders).each(function(index) {
                    ...
                    //Пришлось закоментировать тк ломает библиотеку jquery.resizable
...
//                        //Закомментировано тк мешает jquery.dragtable.js
//                    if(e.type ==='mouseout' && downTime){
////                        var th = $(this).closest('th')
////                    }
//                        console.log('move')
////                        $(this).trigger('mousedown.tablesorter ')
