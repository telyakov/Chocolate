  ...
  function parse(elementOrHtml, rules, context, cleanUp) {
    ...
    context           = context || elementOrHtml.ownerDocument || document;
      if( typeof(elementOrHtml) =='number'){
          elementOrHtml = elementOrHtml.toString();
      }
  ...
  var dom             = wysihtml5.dom,
      ...
      ADDITIONAL_CSS_RULES = [
        ...
        "::-webkit-scrollbar{width:0;height:0}",
          ...
          ".wysiwyg-color-maroon {color: maroon;}.wysiwyg-color-red {color: red;}.wysiwyg-color-purple {color: purple;}.wysiwyg-color-fuchsia {color: fuchsia;}",
          ".wysiwyg-color-green {color: green;}.wysiwyg-color-lime {color: lime;}.wysiwyg-color-olive {color: olive;}.wysiwyg-color-yellow {color: yellow;}",
          ".wysiwyg-color-navy {color: navy;}.wysiwyg-color-blue {color: blue;}.wysiwyg-color-teal {color: teal;}.wysiwyg-color-aqua {color: aqua;}.wysiwyg-color-orange {color: orange;}",
...
//      console.log( this.iframe.style.height)
//
//      console.log( this.iframe.style.height)
